 ...
 * @author PASANTIA
 */
public class AddingFaltante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar un Faltante");
        ...
        jLabel16.setText("Concepto de Desincorporación: No. 60");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (nbien_txt.equals("")) {
            ...
            if (scc.addFaltantes(data)) {
                JOptionPane.showMessageDialog(null, "¡Éxito al añadir el faltante, Bien Nº " + nrobien + " a la base de datos!\n"
                ...
                JOptionPane.showMessageDialog(null, "ERROR AL AÑADIR EL FALTANTE DEL BIEN NRO. " + nrobien + " A LA BASE DE DATOS.", ".::ERROR CRÍTICO - Sistema de Inventario de Bienes del Programa de Informática Integral::.", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddingFaltante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddingFaltante().setVisible(true);
            }
        });
    }
